                ...
                <nav class="navbar navbar-expand-lg navbar-light ml-auto">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav mr-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="index.php?controller=page&action=about">About</a>
                            </li>
                            <?php
                            ...
                            ?>
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="index.php?controller=utilisateur&action=inscription">Inscription</a>
                                </li>
                            <?php
                            }
                            ?>
